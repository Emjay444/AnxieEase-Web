...
const DashboardNew = () => {
  ...
  useEffect(() => {
    const loadDashboardData = async () => {
      try {
        ...
        // Mock appointment requests and recent activity for now
        setAppointmentRequests([
          {
            ...
            status: "pending",
            message: "First-time consultation for anxiety management",
          },
        ]);
  ...
  const CalendarModal = ({ isOpen, onClose }) => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      days.push(
        <div
          key={day}
          className={`p-2 text-center cursor-pointer rounded-lg hover:bg-emerald-50 ${
  ...
  const handleAppointmentAction = (requestId, action) => {
    ...
    // Here you would make an API call to approve/decline the request
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="text-center py-12 text-gray-500">
                ...
                <p>
                  Click "Open Full Calendar" to view and manage appointments
                </p>
              </div>
            </div>
